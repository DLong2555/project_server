...
public interface IGalleryDAO {
	...
	public ArrayList<EventVO> getEventContentsWhenMem(ArrayList<String> gymNameList, int offset, int limit); //특수활동 공고 가져오기
	public int getEventTotalPage(ArrayList<String> gymNameList); //총 게시글 개수 가져오기
	public ArrayList<EventVO> getEventContentsWhenAdmin(String memId, int offset, int limit); // 특수활동 공고 가져오기
	...
	public ArrayList<GalleryVO> getGallContentsWhenMem(ArrayList<String> gymNameList, int offset, int limit); // 갤러리 가져오기 - 회원
	public ArrayList<GalleryVO> getGallContentsWhenAdmin(String memId, int offset, int limit); // 갤러리 가져오기 - 관장

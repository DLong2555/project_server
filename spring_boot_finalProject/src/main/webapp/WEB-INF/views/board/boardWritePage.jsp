...
<script src="<c:url value='/js/boardWritePage.js'/>"></script>
				...
				<form id="boardWriteForm" method="post"
					...
					<div id="boardWritePageWriteBox">
						...
						<div class="boardWritePageSelect">
							...
							<c:if test="${gymNo != null}">
								<div class="boardWritePageSelectPlaceholder">
									공지
									<div class="boardWritePageDown"></div>
								</div>
								<div class="boardWritePageSubSelect">
									<div class="boardWritePageSubSelectEach" data-value="공지">공지</div>
									<div class="boardWritePageSubSelectEach" data-value="공지">특수</div>
									<div class="boardWritePageSubSelectEach" data-value="중고">중고</div>
									<div class="boardWritePageSubSelectEach" data-value="문의">문의</div>
									<div class="boardWritePageSubSelectEach" data-value="자유">자유</div>
								</div>
							</c:if>

...
<head>
	...
	<script src="<c:url value='/js/insertProductForm.js'/>"></script>
			...
			<div id="insertProductPageContainer" class="noto-sans-kr">
				<div id="insertProductPageTitleBox">
					...
					<div class="textAreaBox">
						...
						<div id="prdMain" class="textArea" contenteditable="true"></div>
					</div>
					...
					<div class="textAreaBox">
						...
						<div id="prdDetail" class="textArea" contenteditable="true"></div>
					</div>
					...
					<div id="insertProductPageButtonBox">
						<input type="submit" id="insertPrdBtn" class="btn" value="등록">
					</div>
			</div>
		</div>
	</div>
